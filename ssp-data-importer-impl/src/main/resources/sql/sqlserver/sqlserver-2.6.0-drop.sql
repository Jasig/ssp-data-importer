...
/* ADDED TABLES 2.6 **/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stg_external_external_student_risk_indicator]') AND type in (N'U'))
DROP TABLE  dbo.stg_external_external_student_risk_indicator ;
