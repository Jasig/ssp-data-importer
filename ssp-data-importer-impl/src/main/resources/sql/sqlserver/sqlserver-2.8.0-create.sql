...
CREATE TABLE [dbo].[stg_external_student_transcript](
	...
	[local_gpa] [decimal](9, 2) NULL,
	[program_gpa] [decimal](9, 2) NULL,
PRIMARY KEY CLUSTERED
(
	[school_id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
...
CREATE TABLE [dbo].[stg_external_student_transcript_course](
	...
	[participation] [nvarchar](15) NULL,
PRIMARY KEY CLUSTERED 
(
	[school_id] ASC,
	[term_code] ASC,
...
CREATE TABLE stg_external_student_risk_indicator (
	...
	[indicator_value_description] [nvarchar](2500) NULL,
 CONSTRAINT [stg_external_student_risk_indicator_pkey] PRIMARY KEY CLUSTERED
(
	[school_id] ASC,
	[model_code] ASC,
	[indicator_code] ASC
...
CREATE TABLE [dbo].[stg_external_student_transcript_non_course](
	[batch_id] [bigint],
	[school_id] [nvarchar](50) NOT NULL,
	[target_formatted_course] [nvarchar](35) NOT NULL,
	[term_code] [nvarchar](25) NOT NULL,
	[non_course_code] [nvarchar](50) NOT NULL,
	[title] [nvarchar](100) NULL,
	[description] [nvarchar](2500) NULL,
	[grade] [nvarchar](10) NULL,
	[credit_earned] [decimal](9, 2) NULL,
	[credit_type] [nvarchar](25) NOT NULL,
...
CREATE TABLE [dbo].[stg_external_student_special_service_group](
	[batch_id] [bigint],
	[school_id] [nvarchar](50) NOT NULL,
	[code] [nvarchar](50) NOT NULL,
PRIMARY KEY CLUSTERED 
