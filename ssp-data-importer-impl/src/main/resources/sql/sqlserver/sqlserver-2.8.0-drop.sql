...
/* ADDED TABLES 2.6 **/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stg_external_student_risk_indicator]') AND type in (N'U'))
DROP TABLE  dbo.stg_external_student_risk_indicator ;

/* ADDED TABLES 2.7 **/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stg_external_career_decision_status]') AND type in (N'U'))
DROP TABLE  dbo.stg_external_career_decision_status;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stg_external_student_transcript_non_course]') AND type in (N'U'))
DROP TABLE  dbo.stg_external_student_transcript_non_course;

/* ADDED TABLES 2.8 **/
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stg_external_student_special_service_group]') AND type in (N'U'))
DROP TABLE  dbo.stg_external_student_special_service_group;
