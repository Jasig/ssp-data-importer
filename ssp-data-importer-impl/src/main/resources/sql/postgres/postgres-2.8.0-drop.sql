...
DROP TABLE  IF EXISTS stg_external_student_risk_indicator;
DROP TABLE  IF EXISTS stg_external_career_decision_status;
DROP TABLE  IF EXISTS stg_external_student_transcript_non_course;
DROP TABLE  IF EXISTS stg_external_student_special_service_group;
