...
REVOKE ALL ON SEQUENCE BATCH_STEP_EXECUTION_SEQ FROM PUBLIC;
REVOKE ALL ON SEQUENCE BATCH_STEP_EXECUTION_SEQ FROM sspadmin;
GRANT ALL ON SEQUENCE BATCH_STEP_EXECUTION_SEQ TO sspadmin;
GRANT ALL ON SEQUENCE BATCH_STEP_EXECUTION_SEQ TO ssp;

REVOKE ALL ON SEQUENCE BATCH_JOB_EXECUTION_SEQ FROM PUBLIC;
REVOKE ALL ON SEQUENCE BATCH_JOB_EXECUTION_SEQ FROM sspadmin;
GRANT ALL ON SEQUENCE BATCH_JOB_EXECUTION_SEQ TO sspadmin;
GRANT ALL ON SEQUENCE BATCH_JOB_EXECUTION_SEQ TO ssp;

REVOKE ALL ON SEQUENCE BATCH_JOB_SEQ FROM PUBLIC;
REVOKE ALL ON SEQUENCE BATCH_JOB_SEQ FROM sspadmin;
GRANT ALL ON SEQUENCE BATCH_JOB_SEQ TO sspadmin;
GRANT ALL ON SEQUENCE BATCH_JOB_SEQ TO ssp;
...
CREATE TABLE stg_external_person (
    ...
    campus_code character varying(10)
);
...
CREATE TABLE stg_external_student_transcript (
    ...
    local_gpa numeric(9,2),
    program_gpa numeric(9,2)
);
...
CREATE TABLE stg_external_student_transcript_course (
    ...
    participation character varying(15)
);
...
CREATE TABLE stg_external_student_risk_indicator (
  batch_id BIGINT,
  school_id character varying(50) NOT NULL,
  ...
  indicator_value character varying(50) NOT NULL,
  indicator_value_description character varying(2500)
);

CREATE TABLE stg_external_career_decision_status (
  batch_id BIGINT,
  school_id character varying(50) NOT NULL,
  code character varying(2) NOT NULL
);

CREATE TABLE stg_external_student_transcript_non_course (
	batch_id BIGINT ,
    school_id character varying(50) NOT NULL,
    target_formatted_course character varying(35) NOT NULL,
    term_code character varying(25) NOT NULL,
    non_course_code character varying(50) NOT NULL,
    title character varying(100),
    description character varying(2500),
    grade character varying(10) NOT NULL,
    credit_earned numeric(9,2),
    credit_type character varying(25) NOT NULL,
    status_code character varying(50)
);

CREATE TABLE stg_external_student_special_service_group (
	batch_id BIGINT,
	school_id character varying(50) NOT NULL,
	code character varying(50) NOT NULL
);
...
ALTER TABLE ONLY stg_external_student_financial_aid_award_term
    ADD CONSTRAINT stg_external_student_financial_aid_award_term_pkey PRIMARY KEY (school_id, term_code);
...
ALTER TABLE ONLY stg_external_student_risk_indicator
    ADD CONSTRAINT stg_external_student_risk_indicator_pkey PRIMARY KEY (school_id , model_code , indicator_code);


ALTER TABLE ONLY stg_external_career_decision_status
    ADD CONSTRAINT stg_external_career_decision_status_pkey PRIMARY KEY (school_id);


ALTER TABLE ONLY stg_external_student_transcript_non_course
    ADD CONSTRAINT stg_external_student_transcript_non_course_pkey PRIMARY KEY (school_id, target_formatted_course, term_code, non_course_code);


ALTER TABLE ONLY stg_external_student_special_service_group
    ADD CONSTRAINT stg_external_student_special_service_group_pkey PRIMARY KEY (school_id, code);
...
REVOKE ALL ON TABLE stg_external_student_risk_indicator FROM PUBLIC;
REVOKE ALL ON TABLE stg_external_student_risk_indicator FROM sspadmin;
GRANT ALL ON TABLE stg_external_student_risk_indicator TO sspadmin;
GRANT ALL ON TABLE stg_external_student_risk_indicator TO ssp;


REVOKE ALL ON TABLE stg_external_career_decision_status FROM PUBLIC;
REVOKE ALL ON TABLE stg_external_career_decision_status FROM sspadmin;
GRANT ALL ON TABLE stg_external_career_decision_status TO sspadmin;
GRANT ALL ON TABLE stg_external_career_decision_status TO ssp;

REVOKE ALL ON TABLE stg_external_student_transcript_non_course FROM PUBLIC;
REVOKE ALL ON TABLE stg_external_student_transcript_non_course FROM sspadmin;
GRANT ALL ON TABLE stg_external_student_transcript_non_course TO sspadmin;
GRANT ALL ON TABLE stg_external_student_transcript_non_course TO ssp;

REVOKE ALL ON TABLE stg_external_student_special_service_group FROM PUBLIC;
REVOKE ALL ON TABLE stg_external_student_special_service_group FROM sspadmin;
GRANT ALL ON TABLE stg_external_student_special_service_group TO sspadmin;
GRANT ALL ON TABLE stg_external_student_special_service_group TO ssp;
