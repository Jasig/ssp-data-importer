...
public class RawItemCsvWriter<T> extends AbstractItemStreamItemWriter<T> implements ResourceAwareItemWriterItemStream<T>,
InitializingBean {
    ...
    private ItemLineAggregator<T> lineAggregator;
    ...
    private ItemFlatFileHeaderCallBack headerCallback;
     ...
     */
    public void setLineAggregator(ItemLineAggregator<T> lineAggregator) {
     ...
     */
    public void setHeaderCallback(ItemFlatFileHeaderCallBack headerCallback) {
    ...
    public void write(List<? extends T> items) throws Exception {
        ...
        if (state.lastMarkedByteOffsetPosition == 0) {
            if (headerCallback != null) {
                try {
                    headerCallback.setColumnDescriptorObject(items.get(0));
                    lineAggregator.setOrderedColumns(headerCallback.getOrderedColumnList());
                    headerCallback.writeHeader(state.outputBufferedWriter);
