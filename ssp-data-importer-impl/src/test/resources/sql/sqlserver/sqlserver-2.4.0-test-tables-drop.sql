...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_course]') AND type in (N'U'))
DROP TABLE  dbo.external_course ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_course_program]') AND type in (N'U'))
DROP TABLE  dbo.external_course_program ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_course_requisite]') AND type in (N'U'))
DROP TABLE  dbo.external_course_requisite ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_course_tag]') AND type in (N'U'))
DROP TABLE  dbo.external_course_tag ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_course_term]') AND type in (N'U'))
DROP TABLE  dbo.external_course_term ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_department]') AND type in (N'U'))
DROP TABLE  dbo.external_department ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_division]') AND type in (N'U'))
DROP TABLE  dbo.external_division ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_faculty_course]') AND type in (N'U'))
DROP TABLE  dbo.external_faculty_course ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_faculty_course_roster]') AND type in (N'U'))
DROP TABLE  dbo.external_faculty_course_roster ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_person]') AND type in (N'U'))
DROP TABLE  dbo.external_person ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_person_note]') AND type in (N'U'))
DROP TABLE  dbo.external_person_note ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_person_planning_status]') AND type in (N'U'))
DROP TABLE  dbo.external_person_planning_status ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_program]') AND type in (N'U'))
DROP TABLE  dbo.external_program ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_registration_status_by_term]') AND type in (N'U'))
DROP TABLE  dbo.external_registration_status_by_term ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_student_academic_program]') AND type in (N'U'))
DROP TABLE  dbo.external_student_academic_program ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_student_financial_aid]') AND type in (N'U'))
DROP TABLE  dbo.external_student_financial_aid ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_student_test]') AND type in (N'U'))
DROP TABLE  dbo.external_student_test ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_student_transcript]') AND type in (N'U'))
DROP TABLE  dbo.external_student_transcript ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_student_transcript_course]') AND type in (N'U'))
DROP TABLE  dbo.external_student_transcript_course ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_student_transcript_term]') AND type in (N'U'))
DROP TABLE  dbo.external_student_transcript_term ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_term]') AND type in (N'U'))
DROP TABLE  dbo.external_term ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_student_financial_aid_award_term]') AND type in (N'U'))
DROP TABLE  dbo.external_student_financial_aid_award_term ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_student_financial_aid_file]') AND type in (N'U'))
DROP TABLE  dbo.external_student_financial_aid_file ;
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[external_substitutable_course]') AND type in (N'U'))
DROP TABLE  dbo.external_substitutable_course ;
